...
(defmethod hugsql.core/hugsql-result-fn :1    [sym] 'msc.components.postgres/result-one-snake->kebab)
(defmethod hugsql.core/hugsql-result-fn :one  [sym] 'msc.components.postgres/result-one-snake->kebab)
(defmethod hugsql.core/hugsql-result-fn :*    [sym] 'msc.components.postgres/result-many-snake->kebab)
(defmethod hugsql.core/hugsql-result-fn :many [sym] 'msc.components.postgres/result-many-snake->kebab)
