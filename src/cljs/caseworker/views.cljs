...
(defn- panels [panel-name]
  [:div
   [:nav.navbar.navbar-dark.fixed-top.bg-blue.flex-md-nowrap.p-0.shadow {:style {:text-align "center"}}
    [:a.navbar-brand.col-sm-3.col-md-2.mr-0 {:href "#"
                                             :style {:text-transform "uppercase" :font-weight "bold" :font-family "Arial" :font-size "1.2em" :letter-spacing "2px"}}
     [:img {:src "/img/logo-small.png" :alt "Caseworker" :style {:height "30px" :margin "-7px 5px -5px -15px"}}]]
